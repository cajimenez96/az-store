...
- Name: specs/04-admin-nav.spec.ts >> Admin Panel Navigation >> admin can navigate to products page
- Location: tests/e2e/specs/04-admin-nav.spec.ts:26:7
...
Received string:    "http://localhost:3000/sign-in?callbackUrl=http%3A%2F%2Flocalhost%3A3000%2Fadmin%2Fproducts"
```
