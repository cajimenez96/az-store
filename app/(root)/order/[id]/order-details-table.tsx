    ...
    <div className='bg-az-canvas min-h-screen py-8 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-5xl mx-auto space-y-6'>
        <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2'>
          <h1 className='az-heading-lg text-az-ink-deep tracking-wide'>
            Orden {formatId(id)}
          </h1>
          <div className='flex gap-4 print:hidden'>
            ...
            <Link
              ...
              className='az-body-sm-bold underline text-az-stone hover:text-az-ink transition-colors'
            >
              {isAdmin || isSeller
        ...
        <div className='grid md:grid-cols-3 gap-6'>
          <div className='col-span-2 space-y-6 overflow-x-auto'>
            ...
            <Card className='shadow-az-sticky border-az-hairline-soft bg-az-canvas rounded-az-xxxl'>
              <CardContent className='p-6'>
                <h2 className='az-heading-sm text-az-ink-deep'>
                  Método de Pago
                </h2>
                <div className='mt-2 flex items-center justify-between'>
                  ...
                  {isPaid ? (
                    <Badge
                      variant='secondary'
                      className='bg-green-100 text-az-ink-deep border-transparent'
                    >
                    ...
                    {!receiptUrl ? (
                      <>
                        <div className='p-4 rounded-az-xl bg-az-surface-soft border border-az-hairline-soft space-y-2 text-sm text-az-charcoal'>
                          <h3 className='az-body-sm-bold text-az-ink-deep'>
                        ...
                        <div className='p-6 border border-az-hairline-soft rounded-az-xl bg-az-surface-soft/50'>
                          <FileUploadField
                      ...
                      <div className='bg-az-surface-soft text-az-charcoal p-4 rounded-az-xl border border-az-hairline-soft'>
                        ...
                        <p className='text-sm mt-1 text-az-charcoal'>
                          ...
                          <a
                            ...
                            className='inline-block text-sm underline hover:text-az-ink-deep font-medium'
                          >
              ...
              <CardContent className='p-6'>
                ...
                <div className='mt-4'>
                  <div className='flex items-center gap-2'>
                    <Badge
                      variant='secondary'
                      className='bg-az-surface-soft text-az-ink border-transparent'
                    >
                ...
                <Table className='mt-4'>
                  <TableHeader>
                    <TableRow className='border-b border-az-hairline-soft hover:bg-transparent'>
                      <TableHead className='text-az-stone font-medium'>
                        Producto
                      </TableHead>
                      <TableHead className='text-az-stone font-medium text-center'>
                        Cantidad
                      </TableHead>
                      <TableHead className='text-az-stone font-medium text-right'>
                        Precio
                      </TableHead>
                    </TableRow>
                  </TableHeader>
                        ...
                        <TableCell className='py-4'>
                          ...
                          >
                            ...
                            <div className='flex flex-col'>
                              ...
                              {item.size && (
                                <span className='text-sm text-az-steel'>
                                  Talle: {item.size}
                                </span>
                              )}
                            </div>
          ...
          <div className='space-y-6'>
            <Card className='shadow-az-sticky border-az-hairline-soft bg-az-canvas rounded-az-xxxl'>
              <CardContent className='p-6'>
                <h2 className='az-heading-sm text-az-ink-deep pb-2 border-b border-az-hairline-soft'>
                  Resumen de Compra
                </h2>
                <div className='space-y-4 mt-4'>
                  ...
                  <div className='flex justify-between text-base font-semibold pt-2 border-t border-az-hairline-soft'>
                    ...
                    <div className='text-az-ink-deep font-semibold'>
                  ...
                  {(isAdmin || isSeller) &&
                    ...
                    !receiptUrl && (
                      <div className='space-y-2'>
                        <p className='az-caption text-az-stone text-center'>
